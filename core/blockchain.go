...
import (
	...
	"github.com/ethereumfair/go-ethereum/core/state/snapshot"
	...
	"github.com/ethereumfair/go-ethereum/internal/syncx"
...
func (bc *BlockChain) loadLastState() error {
	...
	if bc.Config().IsAthens(currentBlock.Number()) {
		bc.Config().ReNewChainId()
	}
